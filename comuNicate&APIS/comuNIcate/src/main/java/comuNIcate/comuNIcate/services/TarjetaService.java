...
public class TarjetaService {
    ...
    public Tarjeta getTarjetaById(Long pan){
    ...
    public List<Tarjeta> getTarjetaByUsuario(Long idUsuario){
    ...
    public Tarjeta updateTarjeta(Long pan,Tarjeta newTarjeta){
    ...
    public Tarjeta PartialupdateTarjeta(Long pan,Tarjeta newTarjeta){
        Tarjeta tarjeta = tarRepo.findById(pan)
                .orElseThrow(()->new ResponseStatusException(HttpStatus.NOT_FOUND,"Tarjeta no encontrada"));
        if (newTarjeta.getNombreTarjeta()!=null && !newTarjeta.getNombreTarjeta().isBlank()){
            tarjeta.setNombreTarjeta(newTarjeta.getNombreTarjeta());
    ...
    //Borra una tarjeta
    public void deleteTarjetaById(Long pan){
        Tarjeta tarjeta = tarRepo.findById(pan)
                .orElseThrow(()->new ResponseStatusException(HttpStatus.NOT_FOUND,"Tarjeta no encontrada"));
